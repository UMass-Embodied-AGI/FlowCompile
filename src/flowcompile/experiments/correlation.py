...
from flowcompile.core.analysis.reporting import calculate_latency_from_trace
from flowcompile.core.analysis import load_latency_data
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m flowcompile.experiments.correlation \\
