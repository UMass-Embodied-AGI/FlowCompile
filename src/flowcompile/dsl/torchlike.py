...
from flowcompile.dsl.structure_inference import infer_structures
...
class WorkflowModule:
    ...
    def __init__(self, name: Optional[str] = None, execution_mode: str = "sequential"):
        from flowcompile.dsl.auto_backward import validate_execution_mode
    ...
    def backward(self, payload: Dict[str, Any]) -> pd.DataFrame:
        from flowcompile.dsl.auto_backward import auto_backward
