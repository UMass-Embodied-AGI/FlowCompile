...
Examples:
```bash
python -m flowcompile.core.cli test --dataset <alias-or-name>
python -m flowcompile.core.cli runtime infer --compiled <compiled_json> --workflow-type <workflow_type> --query "..."
```
