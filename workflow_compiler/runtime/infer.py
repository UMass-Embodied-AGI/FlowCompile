...
def infer_runtime(
    ...
    return _format_runtime_record(query_payload, selected, execution)
...
def infer_runtime_batch(
    ...
    return [_format_runtime_record(query, selected, execution) for (query, _), execution in zip(pairs, executions)]
