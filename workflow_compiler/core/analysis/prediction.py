...
from workflow_compiler.core.analysis.modeling import (
    extract_model_name,
...
"""
Simplified workflow prediction functions that delegate to workflow_compiler modules.
...
from workflow_compiler.core.analysis.modeling import is_pareto_efficient


def predict_workflow_by_level_simplified(data_file, output_dir, args, workflow_type):
    """
    Simplified workflow prediction function that delegates to workflow_compiler modules.
